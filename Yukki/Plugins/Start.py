...
@app.on_message(filters.command(["sidhu", "sid"]) & filters.group)
@PermissionCheck
...
@app.on_message(filters.command("sidharth") & filters.group)
@PermissionCheck
...
@app.on_callback_query(filters.regex("sidharths"))
